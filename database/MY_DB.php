...
function &DB($params = '', $query_builder_override = null)
{
    ...
    if (is_string($params) && strpos($params, '://') === false) {
        ...
        // Database settings can be passed as discreet parameters or as a data source name in the first parameter. DSNs must have this prototype: $dsn = 'driver://username:password@hostname/database';
...
/* End of file MY_DB.php */
/* Location: ./application/third_party/database/MY_DB.php */
